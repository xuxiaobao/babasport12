			...
			<tbody>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h"></td>
						...
						<input id="path" type="hidden" name="imgUrl" value="${brand.imgUrl}"/>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" class="required" name="name" maxlength="80"  size="60" value="${brand.description}"/>
					</td>
				</tr>
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						排序:</td><td width="80%" class="pn-fcontent">
						<input type="text" class="required" name="name" maxlength="80" value="${brand.sort}"/>
					</td>
				</tr>
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
