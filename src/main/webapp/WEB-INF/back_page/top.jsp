                     ...
                     <div class="nav">
                     	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                <td>
                                	<ul class="nav-menu">
                                    	<li class="current" id="tb_11" onclick="HoverLi(11);"><a href="/control/main.do" target="mainFrame">首页</a></li>
										<li class="sep"></li><li class="normal" id="tb_12" onclick="HoverLi(12);"><a href="/control/frame/product_main.do" target="mainFrame">商品</a></li>
										<li class="sep"></li><li class="normal" id="tb_13" onclick="HoverLi(13);"><a href="/control/frame/order_main.do" target="mainFrame">订单</a></li>
										<li class="sep"></li><li class="normal" id="tb_14" onclick="HoverLi(14);"><a href="/control/frame/product_main.jsp" target="mainFrame">支付</a></li>
										<li class="sep"></li><li class="normal" id="tb_15" onclick="HoverLi(15);"><a href="/control/frame/product_main.jsp" target="mainFrame">资源</a></li>
										<li class="sep"></li><li class="normal" id="tb_16" onclick="HoverLi(16);"><a href="/control/frame/product_main.jsp" target="mainFrame">辅助</a></li>
										<li class="sep"></li><li class="normal" id="tb_17" onclick="HoverLi(17);"><a href="/control/frame/product_main.jsp" target="mainFrame">维护</a></li>
										<li class="sep"></li><li class="normal" id="tb_18" onclick="HoverLi(18);"><a href="/control/frame/product_main.jsp" target="mainFrame">生成</a></li>
										<li class="sep"></li><li class="normal" id="tb_19" onclick="HoverLi(19);"><a href="/control/frame/product_main.jsp" target="mainFrame">用户</a></li>
										<li class="sep"></li><li class="normal" id="tb_20" onclick="HoverLi(20);"><a href="/control/frame/product_main.jsp" target="mainFrame">配置</a></li>
                                    </ul>
                                </td>
                              </tr>
                            </table>
